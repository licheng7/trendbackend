 ...
 **/
@ToString
public class AreaEduMResponse implements Serializable {
    ...
    public AreaEduMResponse(List<String> yearList, List<Integer> doctorTeacherList, List<Map<String, Object>> doctorTeacherUnitList, Map<String, List<Object>> doctorTeacherYear, Map<String, Object> doctorTeacherPie) {
        this.yearList = yearList;
        this.doctorTeacherList = doctorTeacherList;
        this.doctorTeacherUnitList = doctorTeacherUnitList;
        this.doctorTeacherYear = doctorTeacherYear;
