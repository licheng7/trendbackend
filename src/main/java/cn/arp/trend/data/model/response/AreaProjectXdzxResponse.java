 ...
 * Time:上午2:00
 **/
public class AreaProjectXdzxResponse implements Serializable {
    ...
    public AreaProjectXdzxResponse(List<String> yearList, List<Integer> taskNumData, List<Integer> expenditureNumData, List<Map<String, Object>> unitTaskData, List<Map<String, Object>> unitExpenditureData, String updateTime, Map<String, Object> taskTotal, Map<String, Object> expenditureTotal) {
        this.yearList = yearList;
        this.taskNumData = taskNumData;
        this.expenditureNumData = expenditureNumData;
        this.unitTaskData = unitTaskData;
    ...
    public AreaProjectXdzxResponse() {
    }
}
