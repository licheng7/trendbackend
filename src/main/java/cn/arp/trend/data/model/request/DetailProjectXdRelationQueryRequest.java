 ...
 **/
@ToString
@ApiModel(value="DetailProjectXdRelationQueryRequest", description="detailProject.js的/xdRelation请求参数")
@Validated
public class DetailProjectXdRelationQueryRequest implements Serializable {

    private static final long serialVersionUID = -4182708474336074503L;
