 ...
 * Time:下午9:23
 **/
public class DetailAwardDetailQueryDO {
    ...
    public DetailAwardDetailQueryDO(String startYear, String endYear, List<String> unitIdAry) {
        this.startYear = startYear;
        this.endYear = endYear;
        this.unitIdAry = unitIdAry;
    }

    public DetailAwardDetailQueryDO() {
    }
}
