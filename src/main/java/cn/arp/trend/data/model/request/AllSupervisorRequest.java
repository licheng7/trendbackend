 ...
 **/
@ToString
@ApiModel(value="AllSupervisorRequest", description="detailMentor.js的/distribution/all请求参数")
@Validated
public class AllSupervisorRequest implements Serializable {

    private static final long serialVersionUID = 2977547265892656833L;
