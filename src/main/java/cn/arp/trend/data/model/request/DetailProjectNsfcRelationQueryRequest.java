 ...
 **/
@ToString
@ApiModel(value="DetailProjectNsfcRelationQueryRequest", description="detailProject.js的/nsfcRelation请求参数")
@Validated
public class DetailProjectNsfcRelationQueryRequest implements Serializable {
