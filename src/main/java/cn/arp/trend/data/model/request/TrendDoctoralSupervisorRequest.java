 ...
 **/
@ToString
@ApiModel(value="TrendDoctoralSupervisorRequest", description="detailMentor.js的/trend/d请求参数")
@Validated
public class TrendDoctoralSupervisorRequest implements Serializable {
