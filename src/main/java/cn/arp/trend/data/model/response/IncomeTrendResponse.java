 ...
 * Time:下午9:02
 **/
public class IncomeTrendResponse implements Serializable {
    ...
    public IncomeTrendResponse() {
    }

    public IncomeTrendResponse(List<Map<String, Object>> detail, List<Map<String, Object>> resultArray) {
        this.detail = detail;
