...
public class TrendAllQueryDO {
    ...
    public TrendAllQueryDO(String startYear, String endYear, List<String> affiliationId, List<String> fieldName) {
        this.startYear = startYear;
        this.endYear = endYear;
        this.affiliationId = affiliationId;
        this.fieldName = fieldName;
