 ...
 **/
@ToString
public class AreaFinanceOverviewResponse implements Serializable {
    ...
    public AreaFinanceOverviewResponse(List<List<Map<String, Object>>> resultList) {
        this.resultList = resultList;
    }

    public AreaFinanceOverviewResponse() {
    }
}
