 ...
 **/
@ToString
public class AreaHrAcadCaeDistResponse implements Serializable {
    ...
    public AreaHrAcadCaeDistResponse(Map<String, Object> proportion, List<Map<String, Object>> unitData, String updateTime) {
        this.proportion = proportion;
        this.unitData = unitData;
        this.updateTime = updateTime;
    }

    public AreaHrAcadCaeDistResponse() {
    }
}
