 ...
 **/
@ToString
@ApiModel(value="ChildLevelDistributionRequest", description="detailStaff.js的/childLevelDistribution请求参数")
@Validated
public class ChildLevelDistributionRequest implements Serializable {
